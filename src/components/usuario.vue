...
<script setup>
  ...
  const cargarTodasReservasPendientes = async () => {
    try {
      const response = await axios.get("https://gestiontenis-1.onrender.com/api/reservas/pendientes");
  ...
  const cargarEmparejamientosConfirmados = async () => {
    try {
      const response = await axios.get("https://gestiontenis-1.onrender.com/api/reservas/emparejamientos-confirmados");
  ...
  const guardarDisponibilidad = async () => {
    ...
    try {
      ...
      const response = await axios.post("https://gestiontenis-1.onrender.com/api/reservas", {
  ...
  const cambiarContrasena = async () => {
    ...
    try {
      ...
      await axios.put(`https://gestiontenis-1.onrender.com/api/usuarios/${currentUserId.value}/contrasena`, {
